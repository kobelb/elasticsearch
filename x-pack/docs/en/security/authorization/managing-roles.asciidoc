...
To manage roles which grant {kibana-ref}/kibana-privileges.html[Kibana privileges],
use the {kibana-ref}/role-management-api.html[Kibana Role Management APIs]
